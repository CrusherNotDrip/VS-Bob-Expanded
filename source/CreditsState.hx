...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(FlxG.width - 5, FlxG.height - 24, FlxG.width, "Press CTRL for Official VS Bob Expanded Discord Server", 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.CONTROL) {
			CoolUtil.browserLoad('https://discord.gg/zuNtVdHYWn');
		}
